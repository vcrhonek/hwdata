...
sdio.ids.downloaded:
	@curl -o $@ https://raw.githubusercontent.com/systemd/systemd/master/hwdb.d/sdio.ids
...
new-hwdb-files:
	@for file in $(HWDBUPSTREAM); do \
	    echo $$file; \
	    curl -O https://raw.githubusercontent.com/systemd/systemd/master/hwdb.d/$$file; \
	done
